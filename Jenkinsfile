...
pipeline {
    ...
    environment {
        ...
        DOCKER_FULL_IMAGE = "${env.DOCKER_REPO_PATH}/auth-keycloak:${env.BUILD_NUMBER}"

        // Kubernetes Manifests
        MANIFESTS_REPO_URL = 'https://github.com/Cambofreelance-Software-Development/keycloak-auth-manifest.git'
        ...
        GITHUB_REPO_URL = 'https://github.com/Cambofreelance-Software-Development/keycloak-authentication-server.git'
        ...
        // APPLICATION INFO
        CONTAINER_NAME = "ms-auth-keycloak"
        APPLICATION_PORT = "25011:25011"
    }
