pipeline {
    ...
    environment {
        PROJECT_SERVICE  = "LOTTERY-API-SERVICE"
        GIT_BRANCH = "develop"
        GIT_REPO_URL = "https://github.com/Cambofreelance-Software-Development/lottery-server.git"
        ...
        MANIFEST_FOLDER = "dev/overlays/lottery-api/patches"
        SERVICE_PATCH = "lottery-api-service-patch.yaml"

        IMAGE_REGISTRY = "nexus.cambofreelance.com/docker-hosted"
        FOLDER_REGISTRY = "ms/dev"
        IMAGE_NAME = "lottery-api-service"
